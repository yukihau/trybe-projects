...
INSERT INTO
  SpotifyClone.album(album, ano_lancamento, artista_id)
VALUES
  ('Envious', 1990, 1),
  ('Exuberant', 1993, 1),
...
INSERT INTO
  SpotifyClone.cancao(cancao, duracao_segundos, album_id)
VALUES
  ('Soul For Us', 200, 1),
...
INSERT INTO
  SpotifyClone.plano (plano, valor)
VALUES
  ('gratuito', 0),
  ('familiar', 7.99),
  ('pessoal', 6.99),
...
INSERT INTO
  SpotifyClone.usuario (plano_id, usuario, idade, data_assinatura)
VALUES
